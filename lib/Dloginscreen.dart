...
import 'package:sapucar/Dmainscreen.dart';
import 'package:sapucar/Dregisterscreen.dart';
...
class _DLoginScreenState extends State<DLoginScreen> {
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                              ...
                              width: screenWidth,
                              child: Image.asset(
                                  'assets/images/UUMGO SC_Driver.jpg')),
                          const Text(
                            "Driver Login",
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: _registerDriverScreen,
                                ),
                              ),
                            ],
                          ),
  ...
  void _registerDriverScreen() {
    Navigator.pushReplacement(context,
        MaterialPageRoute(builder: (content) => const DRegisterScreen()));
  }
  ...
  void _loginDriver() {
    if (_formKey.currentState!.validate()) {
      _formKey.currentState!.save();
      http.post(
          Uri.parse(CONSTANTS.server + "/SapuCar/mobile/php/login_driver.php"),
          body: {
        ...
        if (response.statusCode == 200 && data['status'] == 'success') {
          ...
          Driver driver = Driver.fromJson(extractdata);
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (content) => DMainScreen(
                        driver: driver,
                      )));
        } else {
          Fluttertoast.showToast(
